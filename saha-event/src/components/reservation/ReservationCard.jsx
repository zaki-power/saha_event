    ...
    <div className="flex flex-col gap-2">
      ...
      {status === 'rejected' && (
        <div className="bg-orange-50 border border-orange-100 p-4 rounded-xl text-sm text-orange-800">
          <p className="font-bold mb-1">⚠️ Votre réservation a été rejetée.</p>
          <p>Votre paiement sera remboursé intégralement si les informations envoyées sont correctes. Veuillez contacter le support pour plus d'informations.</p>
        </div>
      )}
    </div>
  )
